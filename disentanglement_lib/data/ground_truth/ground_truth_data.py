...
class GroundTruthData(object):
  ...
  def sample_factor_pairs(self, num, random_state):
    """Sample a batch of paired factors for weakly supervised models"""
    raise NotImplementedError()
  ...
  def sample_pair_observations(self, num, random_state, k):
    ...
    factors1, factors2 = self.sample_factor_pairs(num, random_state)
    sample1 = self.sample_observations_from_factors(factors1, random_state)
